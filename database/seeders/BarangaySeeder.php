...
class BarangaySeeder extends Seeder
{
    ...
    {
        $barangays = [
            'Aggasian', 'Alibagu', 'Alinguigan 1st', 'Alinguigan 2nd', 'Alinguigan 3rd',
            ...
            'Carikkikan Norte', 'Carikkikan Sur', 'Centro – San Antonio', 'Centro Poblacion', 'Fugu',
        ...
        foreach ($barangays as $name) {
            Barangay::factory()->create([
                ...
                'province' => 'Isabela',
                'zip_code' => '3300',
                'founded_year' => fake()->numberBetween(1900, 1990),
                'barangay_code' => fake()->numerify('###-######'),
                'barangay_type' => fake()->randomElement(['urban', 'rural']),
            ]);
        }
    }
}
