...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('households', function (Blueprint $table) {
            ...
            $table->string('ownership_type', 55)->nullable();
            $table->enum('housing_condition', ['good', 'needs_repair', 'dilapidated'])->nullable();
            $table->year('year_established')->nullable();
            $table->enum('house_structure', ['concrete', 'semi_concrete', 'wood', 'makeshift'])->nullable();
