...
<html>
<head>
    <title>{{ $barangayName }} - Barangay Institution Members</title>
    <style>
...
<h3 style="margin-bottom: 4px;"> {{$barangayName  }}</h3>
...
<tr>
    ...
    <td>{{ $m['PWD'] ?? 'No' }}</td>
    <td>{{ $m['4Ps Beneficiary'] ?? 'No' }}</td>
    <td>{{ $m['Solo Parent'] ?? 'No' }}</td>
</tr>
@empty
<tr>
...
<table class="summary-table">
    <tr><th>Total Members</th><td>{{ $summary['total'] }}</td></tr>
    <tr><th>Male</th><td>{{ $summary['male'] }}</td></tr>
    <tr><th>Female</th><td>{{ $summary['female'] }}</td></tr>
    <tr><th>PWD</th><td>{{ $summary['pwd'] }}</td></tr>
    <tr><th>4Ps Beneficiary</th><td>{{ $summary['fourps'] }}</td></tr>
    <tr><th>Solo Parent</th><td>{{ $summary['solo_parent'] }}</td></tr>
</table>
