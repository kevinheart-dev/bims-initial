...
<html>
<head>
    <title>{{ $barangayName }} - Resident Information Summary ({{ $year ?? 2025 }})</title>
    <style>
        body {
...
<body>
    ...
    <!-- Title -->
    <h2>{{ $barangayName }} Resident Information Summary</h2>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $resident['ethnicity'] ?? 'N/A' }}</td>
                <td>{{ $resident['religion'] ?? 'N/A' }}</td>
                <td>{{ $resident['contact_number'] ?? 'N/A' }}</td>
                <td>{{ $resident['email'] ?? 'N/A' }}</td>
                <td>{{ $resident['registered_voter'] ?? 'No' }}</td>
                <td>{{ $employmentStatuses[$resident['employment_status']] ?? 'N/A' }}</td>
                <td>{{ $resident['is_4ps'] ?? 'No' }}</td>
            ...
            <!-- Totals Row -->
            <tr>
                <td colspan="18" style="text-align:left; font-size:10px; padding-top:6px; padding-bottom:4px; color:#555; font-style:italic; border-top:1px solid #ccc;">
    ...
    <!-- Summary Section -->
    <h3 style="margin-top:12px; text-align:left; text-decoration: underline;">Resident Summary</h3>
    ...
    <table style="width: 50%; border-collapse: collapse; margin-top: 8px; font-size: 10px; line-height: 1.4;">
        ...
        <tbody>
            <tr>
                <td style="border:1px solid #333; padding:6px 8px; text-align:left; vertical-align: top;">Total Residents</td>
            ...
            <tr>
                <td style="border:1px solid #333; padding:6px 8px; text-align:left; vertical-align: top;">Registered Voters</td>
                <td style="border:1px solid #333; padding:6px 8px; text-align:left; vertical-align: top;">{{ $residents->where('registered_voter', 'Yes')->count() }}</td>
            </tr>
            <tr>
                <td style="border:1px solid #333; padding:6px 8px; text-align:left; vertical-align: top;">4Ps Beneficiaries</td>
                <td style="border:1px solid #333; padding:6px 8px; text-align:left; vertical-align: top;">{{ $residents->where('is_4ps', 'Yes')->count() }}</td>
            </tr>
            <tr>
    ...
    <p style="margin-top:6px; font-size:9px; line-height:1.3;">
        Note: This summary is based on the data of residents currently registered in {{ $barangayName }}.
