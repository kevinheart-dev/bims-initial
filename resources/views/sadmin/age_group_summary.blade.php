...
<html>
<head>
    <title>Age Group Summary - {{ $year ?? 2025 }}</title>
    <style>
        body {
...
<body>
    ...
    <h2>Age Group Summary by Barangay</h2>
    ...
    <table>
        ...
        <tbody>
            @php $index = 1; @endphp
            @foreach($ageGroupsPerBarangay as $barangayName => $data)
                @php
                    $totalPopulation = array_sum($data);
                @endphp
