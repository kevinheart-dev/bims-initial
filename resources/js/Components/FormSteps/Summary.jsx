...
import { HOUSEHOLD_WATER_SOURCE_TEXT } from "@/constants";
...
const Summary = ({ onBack, onSubmit }) => {
    ...
    return (
        <section className="max-w-7xl mx-auto p-6">
            ...
            <section
                aria-labelledby="house-information-heading"
                className="mb-10"
            >
                <h3
                    id="house-information-heading"
                    className="text-2xl font-semibold mb-3"
                >
                    House Information
                </h3>
                    ...
                    {[
                        {
                            ...
                            value: userData.ownership_value,
                        },
                        {
                        ...
                        {
                            label: "Water Source",
                            value: HOUSEHOLD_WATER_SOURCE_TEXT[
                                userData.water_source_type
                            ],
                        },
                        {
                            ...
                            value:
                                wasteManagementLabels[
                                    userData.waste_management_type
                                ] || userData.waste_management_type,
                        },
                        {
