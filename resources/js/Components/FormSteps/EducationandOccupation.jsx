...
function EducationandOccupation({ occupationTypes }) {
    ...
    const handleEducationChange = (familyIndex, memberIndex, educationIndex, e) => {
    ...
    useEffect(() => {
        ...
        // 🔹 Loop across families -> members -> occupations
        const totalIncome = families.reduce((familySum, family) => {
            const familyIncome = (family.members || []).reduce((memberSum, member) => {
                const memberIncome = (member.occupations || []).reduce((occSum, occ) => {
                    return occSum + (parseFloat(occ.monthly_income) || 0);
                }, 0);
                return memberSum + memberIncome;
            }, 0);
            return familySum + familyIncome;
        }, 0);
        ...
        // 🔹 Update household-level income data
        setUserData((prev) => ({
            ...prev,
            household: {
                ...prev.household,
    ...
    return (
        <div>
            ...
            <p className="text-sm text-gray-600 mb-3">
                Please provide education history, occupation and livelihood for each household member.
            </p>
                            ...
                            {family.members?.map((member, mIndex) => {
                                ...
                                return (
                                    <div key={mIndex} className="mt-3 border rounded bg-white">
                                        ...
                                        >
                                            <span>{displayName || `Member ${mIndex + 1}`}</span>
                                            {isOpen ? (
                                                <IoIosArrowUp className="text-xl text-blue-600" />
                                            ) : (
                                                <IoIosArrowDown className="text-xl text-blue-600" />
                                            ...
                                            <div id={`member-panel-${mIndex}`}
                                                ...
                                                {(member.educations || []).map((education, eduIndex) => {
                                                    const showProgram =
                                                        ...
                                                        education.educational_status === "graduated";
                                                        ...
                                                        >
                                                            ...
                                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                                ...
                                                                <div>
                                                                    <DropdownInputField
                                                                        ...
                                                                        onChange={(e) =>
                                                                            handleEducationChange(fIndex, mIndex, eduIndex, e)
                                                                        }
                                                                        placeholder="Select attainment"
                                                                        required
                                                                        items={[
                                                                            { label: "No Education Yet", value: "no_education_yet" },
                                                                            { label: "No Formal Education", value: "no_formal_education" },
                                                                            { label: "Prep School", value: "prep_school" },
                                                                            { label: "Kindergarten", value: "kindergarten" },
                                                                            { label: "Elementary", value: "elementary" },
                                                                            { label: "High School", value: "high_school" },
                                                                            { label: "Senior High School", value: "senior_high_school" },
                                                                            { label: "College", value: "college" },
                                                                            { label: "ALS (Alternative Learning System)", value: "als" },
                                                                            { label: "TESDA", value: "tesda" },
                                                                            { label: "Vocational", value: "vocational" },
                                                                            { label: "Post Graduate", value: "post_graduate" },
                                                                        ]}
                                                                    />
                                                                    {errors?.[`families.${fIndex}.members.${mIndex}.educations.${eduIndex}.education`] && (
                                                                ...
                                                                <div>
                                                                    ...
                                                                    />
                                                                    {errors?.[`families.${fIndex}.members.${mIndex}.educations.${eduIndex}.educational_status`] && (
                                                                        <p className="text-red-500 text-xs">
                                                                            {errors[`families.${fIndex}.members.${mIndex}.educations.${eduIndex}.educational_status`]}
                                                                        </p>
                                                                    )}
                                                                ...
                                                                <div>
                                                                    ...
                                                                    />
                                                                    {errors?.[`families.${fIndex}.members.${mIndex}.educations.${eduIndex}.school_name`] && (
                                                                        <p className="text-red-500 text-xs">
                                                                            {errors[`families.${fIndex}.members.${mIndex}.educations.${eduIndex}.school_name`]}
                                                                        </p>
                                                                    )}
                                                            ...
                                                            <div className={`grid grid-cols-1 ${secondRowCols} gap-4 mt-4`}>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    />
                                                                    {errors?.[`families.${fIndex}.members.${mIndex}.educations.${eduIndex}.school_type`] && (
                                                                        <p className="text-red-500 text-xs">
                                                                            {errors[`families.${fIndex}.members.${mIndex}.educations.${eduIndex}.school_type`]}
                                                                        </p>
                                                                    )}
                                                                ...
                                                                <div>
                                                                    ...
                                                                    />
                                                                    {errors?.[`families.${fIndex}.members.${mIndex}.educations.${eduIndex}.year_started`] && (
                                                                        <p className="text-red-500 text-xs">
                                                                            {errors[`families.${fIndex}.members.${mIndex}.educations.${eduIndex}.year_started`]}
                                                                        </p>
                                                                    )}
                                                                ...
                                                                <div>
                                                                    ...
                                                                    />
                                                                    {errors?.[`families.${fIndex}.members.${mIndex}.educations.${eduIndex}.year_ended`] && (
                                                                        <p className="text-red-500 text-xs">
                                                                            {errors[`families.${fIndex}.members.${mIndex}.educations.${eduIndex}.year_ended`]}
                                                                        </p>
                                                                    )}
                                                                ...
                                                                {education.education === "college" && (
                                                                    <div>
                                                                        ...
                                                                        />
                                                                        {errors?.[`families.${fIndex}.members.${mIndex}.educations.${eduIndex}.program`] && (
                                                                            <p className="text-red-500 text-xs">
                                                                                {errors[`families.${fIndex}.members.${mIndex}.educations.${eduIndex}.program`]}
                                                                            </p>
                                                                        )}
                                                            ...
                                                            <button
                                                                type="button"
                                                                onClick={() => removeEducation(fIndex, mIndex, eduIndex)}
                                                ...
                                                <button
                                                    type="button"
                                                    onClick={() => addEducation(fIndex, mIndex)}
                                                ...
                                                {(member.occupations || []).map((occupation, occIndex) => (
                                                    ...
                                                    >
                                                        <div className="grid md:grid-cols-4 gap-4">
                                                            ...
                                                            <div>
                                                                <RadioGroup
                                                                    ...
                                                                    selectedValue={occupation.is_main_source || ""}
                                                                    options={[
                                                                        { label: "Yes", value: 1 },
                                                                        { label: "No", value: 0 },
                                                                    ]}
                                                        ...
                                                        <button
                                                            type="button"
                                                            onClick={() => removeOccupation(fIndex, mIndex, occIndex)}
                                                ...
                                                <button
                                                    type="button"
                                                    className="flex items-center gap-1 text-sm text-blue-600 hover:text-blue-800 font-medium mt-4 transition-colors duration-200"
                                                    onClick={() => addOccupation(fIndex, mIndex)}
                                                >
                                                    <IoIosAddCircleOutline className="text-4xl" /> <span>Add Occupation</span>
                                                </button>
                                                ...
                                                <div className="hidden">
                                                    <InputField
                                                        ...
                                                        value={userData.household?.family_monthly_income || ""}
                                                        readOnly
                                                    />
                                                    ...
                                                    <DropdownInputField
                                                        ...
                                                        name="income_bracket"
                                                        value={userData.household?.income_bracket || ""}
                                                        items={[userData.household?.income_bracket || ""]}
                                                        readOnly
                                                    />
                                                    ...
                                                    <DropdownInputField
                                                        ...
                                                        value={userData.household?.income_category || ""}
                                                        items={[userData.household?.income_category || ""]}
                                                        readOnly
                                                    />
                                                </div>
