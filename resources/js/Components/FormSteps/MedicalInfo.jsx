...
function MedicalInfo() {
    ...
    useEffect(() => {
        const updatedMembers = members.map((member) => {
            ...
            if (weight_kg && height_cm && age && gender) {
                ...
                return { ...member, bmi: bmi, nutrition_status: status };
            }
        ...
        const hasChanges = updatedMembers.some(
            (m, i) => m.nutrition_status !== members[i]?.nutrition_status,
            (m, i) => m.bmi !== members[i]?.bmi
        );
    ...
    const handleMedicalChange = (index, e) => {
        ...
        const weight =
            name === "weight_kg"
                ? parseFloat(value)
                : updatedMembers[index].weight_kg;
        const height =
            name === "height_cm"
                ? parseFloat(value)
                : updatedMembers[index].height_cm;
