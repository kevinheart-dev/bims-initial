...
//             existingMembers[i] || { ...defaultMember }
//         );
//         setUserData({ ...userData, household: { ...household, families } });
//     };
...
//         // Update first member and all members sharing the same old last name
//         setUserData((prevUserData) => {
//             const updatedHousehold = { ...prevUserData.household };
//             updatedHousehold.families = updatedHousehold.families.map((family) => {
//                 const updatedMembers = family.members.map((member, index) => {
//                     if (index === 0) return { ...member, [name]: value };
//                     if (
//                         ["lastname", "religion", "ethnicity", "citizenship"].includes(name) &&
//                         member.lastname === family.members[0].lastname
//                     ) {
//                         return { ...member, [name]: value };
//                     }
//                     return member;
...
//     useEffect(() => {
//         if (household.families?.length) {
//             household.families.forEach((family) => {
//                 if (family.members?.[0]) {
//                     setSharedFields({
//                         lastname: family.members[0].lastname,
//                         religion: family.members[0].religion,
//                         ethnicity: family.members[0].ethnicity,
//                         citizenship: family.members[0].citizenship,
//                     });
//                 }
//             });
//         }
...
//                         setUserData({
//                             ...userData,
//                             household: { ...household, household_name: e.target.value },
//                         })
//                     }
...
//                                                                     setMembers((prev) =>
//                                                                         prev.map((m, i) =>
//                                                                             i === mIndex ? { ...m, resident_image: file } : m
//                                                                         )
//                                                                     );
//                                                             }}
//                                                             className="block w-full text-sm text-gray-500 file:mr-2 file:py-1 file:px-3 file:rounded file:border-0 file:text-xs file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100"
...
//                                                                 value={member.contactNumber}
//                                                                 onChange={(e) =>
//                                                                     handleMemberChange(fIndex, mIndex, "contactNumber", e.target.value)
//                                                                 }
//                                                                 placeholder="09XX XXXX XXX"
//                                                             />
...
//                                                                     { label: "No", value: 0 },
//                                                                 ]}
//                                                                 onChange={(e) => handleMemberChange(fIndex, mIndex, "is_4ps_benificiary", parseInt(e.target.value))}
//                                                                 required
//                                                             />
...
//                                                                     { label: "No", value: 0 },
//                                                                 ]}
//                                                                 onChange={(e) => handleMemberChange(fIndex, mIndex, "is_solo_parent", parseInt(e.target.value))}
//                                                                 required
//                                                             />
...
//                                                                     onChange={(e) => handleMemberChange(fIndex, mIndex, "solo_parent_id_number", e.target.value)}
//                                                                     placeholder="ID number"
//                                                                 />
...
//                                                                     { label: "No", value: 0 },
//                                                                 ]}
//                                                                 onChange={(e) => handleMemberChange(fIndex, mIndex, "registered_voter", parseInt(e.target.value))}
//                                                                 required
//                                                             />
...
//                                                                         onChange={(e) => handleMemberChange(fIndex, mIndex, "voter_id_number", e.target.value)}
//                                                                         placeholder="Voter ID number"
//                                                                     />
...
//                                                                         ]}
//                                                                         onChange={(e) => handleMemberChange(fIndex, mIndex, "voting_status", e.target.value)}
//                                                                         placeholder="Select status"
//                                                                     />
...
//                                                                         items={barangayList}
//                                                                         onChange={(e) => handleMemberChange(fIndex, mIndex, "registered_barangay", e.target.value)}
//                                                                         placeholder="Select registered barangay"
//                                                                     />
...
//                                                                             ]}
//                                                                             onChange={(e) =>
//                                                                                 handleVehicleChange(fIndex, mIndex, vecIndex, "is_registered", parseInt(e.target.value))
//                                                                             }
//                                                                         />
//                                                                     </div>
