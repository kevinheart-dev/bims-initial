                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            {renderDetail(
                                "Family Type",
                                CONSTANTS.FAMILY_TYPE_TEXT[userData.family_type]
                            )}
                            {renderDetail(
                            ...
                            {renderDetail(
                                ...
                                `₱${userData.family_monthly_income?.toLocaleString() ||
                                "0"
                                }`
                            )}
                            {renderDetail(
                                "Income Bracket",
                                CONSTANTS.INCOME_BRACKET_TEXT[
                                userData.income_bracket
                                ]
                            )}
                            {renderDetail(
                                "Income Category",
                                CONSTANTS.INCOME_CATEGORY_TEXT[
                                userData.income_category
                                ]
                            )}
                        </div>
                    </div>
                            ...
                            <div className="p-4 space-y-4">
                                ...
                                <div className="space-y-3">
                                    ...
                                    {member.has_vehicle == 1 &&
                                        ...
                                        <div
                                            className={`grid ${member.vehicles.length > 1
            ...
            <section className="space-y-4 border border-gray-200 p-4 rounded-md">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    {renderDetail(
                        ...
                        userData.bath_and_wash_area
                        ]
                    )}
                    {renderDetail(
                        "Internet",
                        CONSTANTS.HOUSEHOLD_INTERNET_TYPE_TEXT[
                        userData.type_of_internet
                        ]
                    )}
                    {(userData.toilets || []).length > 0 &&
                        renderDetail(
                            ...
                            (userData.toilets || [])
                                .map(
                                    (toilet) =>
                                        CONSTANTS.HOUSEHOLD_TOILET_TYPE_TEXT[
                                        toilet.toilet_type
                                        ]
                                )
                                .filter(Boolean)
