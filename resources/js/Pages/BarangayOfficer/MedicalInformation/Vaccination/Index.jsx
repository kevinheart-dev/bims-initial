...
export default function Index({ vaccinations, puroks, queryParams }) {
    ...
    const searchFieldName = (field, value) => {
        ...
        router.get(route("vaccination.index", queryParams));
    };
    ...
    const allColumns = [
        ...
        { key: "vaccination_date", label: "Vaccination Date" },
    ...
    const columnRenderers = {
        ...
        vaccine: (row) => row.vaccine ?? "—",

        vaccination_date: (row) =>
    ...
    const confirmDelete = () => {
        router.delete(route("vaccination.destroy", medicalConditionToDelete), {
            onError: (errors) => {
    ...
    return (
        <AdminLayout>
            ...
            <div>
                ...
                {/* <pre>{JSON.stringify(vaccinations, undefined, 2)}</pre> */}
                        ...
                        <div className="bg-white border border-gray-200 shadow-sm rounded-xl sm:rounded-lg p-4 m-0">
                            ...
                            {showFilters && (
                                <FilterToggle
                                    ...
                                    puroks={puroks}
                                    showFilters={true}
                                    clearRouteName="vaccination.index"
                                    clearRouteParams={{}}
                                />
                            )}
                            <DynamicTable
                                passedData={vaccinations}
                                allColumns={allColumns}
