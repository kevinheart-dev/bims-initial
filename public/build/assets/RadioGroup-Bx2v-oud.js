import{j as e}from"./app-OMiIBAVv.js";function m({label:a,name:n,options:c=[],selectedValue:o,onChange:x,disabled:r,required:l}){return e.jsxs("div",{className:"relative mt-4",children:[a&&e.jsxs("label",{className:`block text-sm font-semibold mb-3
